...
public class SOAImageProvider extends ContentProvider {
    private Context mContext;
    private DataBaseAssistant mDBassitant;
    static final String PROVIDER_NAME = "com.soa4id.tec.shareactionsender.SOAImageProvider";
    ...
    static {
        ...
        mUriMatcher.addURI(PROVIDER_NAME,"images",1);
        mUriMatcher.addURI(PROVIDER_NAME,"images/#",2);
    }
    ...
    public boolean onCreate() {
        mContext = getContext();
        mDBassitant = new DataBaseAssistant(mContext);
        return true;
    }
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        Cursor result = this.mDBassitant.getAll();
        Log.i("provider",uri.getAuthority());
